        ...
        <Col sm={12}>
          ...
          >
            <SwiperSlide>
              ...
              <div>
                <p>Tecnica: Xilografia<br />
                  Dim. lastra: 600x400mm<br />
                  Dim. foglio: 70x50cm<br />
                  Descrizione opera:<br />
                  Nasce come omaggio alla bellezza delle creature marine (alla loro libertà di muoversi nell'immensità dell'oceano), poi diventa una denuncia, un grido d'allarme, di una nuova fonte di inquinamento: le "reti fantasma", reti da pesca abbandonate nei fondali, trappole vere e proprie che non lasciano via di scampo alla fauna marina e che si riducono in frammenti sempre più piccoli (con il calore del sole e il movimento delle onde) fino a diventare microplastiche dannose anche per l'essere umano.</p></div>
